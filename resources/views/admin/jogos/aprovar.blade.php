...
<div>
	...
	@endif
	<form method="POST" action="{{route('admin.jogos.aprovar.submit', $jogo->nomeJogo)}}" enctype="multipart/form-data">
		...
		<button class="btn btn-primary" type="submit">Aprovar <i class="glyphicon glyphicon-ok"></i></button>
	</form>
	</br>
</div>
@stop
